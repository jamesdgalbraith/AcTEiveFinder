...
public class GenerateAnnotatedLibrary {
	...
	private static String GBTE = "/data/rc003/BlastDB/GB_TE.21032016.fa";
	private static String ALLR = "/data/rc003/BlastDB/all_retrovirus.fasta";
	private static double restMinCoverage = .8;
	private static double sineMinCoverage = .8;
	private static boolean debug = false;

	public static void main (String[] args) {
		String species = args[0];
		String iDir = "/home/a1194388/fastdir/Carp/" + species + "/";
		String library = iDir + species + "_Denovo_TE_Library.fasta";
		String headers = iDir + "wantedCSHeaders.txt";
		String CSFile = iDir + "consensus.fasta";
		String TEgff = iDir + "notKnown.tewb.gff";
		String ERVgff = iDir + "notKnown.ervwb.gff";
		String SSR = iDir + "SSR.txt";
		String Proteins = iDir + "protein.txt";
		String IRS = iDir + "consensus.fasta.map"; 
		String IRM = iDir + "known.txt";
		...
		try {
			...
			writeConsensusSequences(TEgff, ERVgff, SSR, Proteins, IRS, IRM, CSFile, out, headersOnly);
			out.close();
			}
	...
	private static class RBClassifier {
  	...
  	private void addUnknownClassifications (Hashtable<String, String> classifications) {
		...
		private String getLibraryDirectory () {
			return "/home/a1194388/fastdir/krishna_databases/RepBase22.12_fasta";
			}
		}

	private static void addIRHits (Hashtable<String, CS> wantedCS, String IRS) {
		String line = null;
		try {
	...
	private static Hashtable<String, List<Hit>> getRetroHits(String TEgff, String ERVgff) {
	...
	private static Hashtable<String, CS> getWantedCSs (Hashtable<String, List<Hit>> retroHits, String SSR, String Proteins, String CSFile) {
	...
	private static void writeConsensusSequences (String TEgff, String ERVgff, String SSR, String Proteins, String IRS, String IRM, String CSFile, BufferedWriter out, boolean headersOnly) {
		//get wanted
		Hashtable<String, CS> wantedCS = getWantedCSs(getRetroHits(TEgff, ERVgff), SSR, Proteins, CSFile);
		//get IR annots for wanted
		addIRHits(wantedCS, IRS);
